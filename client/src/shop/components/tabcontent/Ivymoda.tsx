...
import Button from "../../assets/themes/Button/Button";
...
import { ivymodaImage } from "../../assets/data/ivymodaData";
const Ivymoda = () => {
  return (
    <div className="ivymoda-style" >
      <Swiper
        ...
        className="mySwiper"
      >
        {ivymodaImage.map((item, index) => {
          return<SwiperSlide key={item.imgUrl}>
            <div className="ivymoda-style" >
